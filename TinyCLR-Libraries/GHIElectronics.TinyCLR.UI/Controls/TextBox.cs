...
namespace GHIElectronics.TinyCLR.UI.Controls {
    ...
    public class TextBox : Control {
        ...
        public enum TextMode { Text, Password }
        public TextMode Mode { get; set; } = TextMode.Text;
        ...
        public override void OnRender(DrawingContext dc) {
            ...
            dc.DrawText(ref txt, this._font, b.Color, x, y, w, this._font.Height, this.TextAlign, TextTrimming.CharacterEllipsis);
                ...
                dc.DrawText(ref mask, this._font, b.Color, x, y, w, this._font.Height, this.TextAlign, TextTrimming.CharacterEllipsis);
            }
        }
    }
}
